...
\item[2019] \tab Natera, L., Battiston, F., I\~niguez, G., Szell, M. \enquote{Data-driven strategies for optimal bicycle network growth} \textit{ArXiv ID: 1907.07080}.
...
\item[2018] \tab Natera, L., Reguillo, R. \enquote{Comunicación y cambio social: participación política e internet en Jalisco} \textit{Enciclopedia Jaliscience de la Comunicación.}, edited by Orozco, G., Reguillo, R. Jalisco, Mexico: Universidad de Guadalajara.

\item[2018] \tab Natera, L. \enquote{Un cambio de la comunicación gubernamental y política. De los medios de comunicación a las redes sociales.} \textit{Informe Anual Q Medios 2018}, edited by Bernal, G. Jalisco, Mexico: ITESO.
...
\item[2016] \tab Natera, L. (as Signa\_Lab) \enquote{Battle of the hashtags: Mapping the online conversation surrounding Mexico's gas price} \textit{Global Voices.}
...
\item[2014] \tab Natera, L. \enquote{Comunicación, ciudad e internet: flujos de información urbana en entornos digitales} VI Seminatio Internacional de Investigación en Urbanismo. Bogota, Colombia.
...
\item[2019] \tab \enquote{Data-driven strategies for optimal bicycle network growth} Mobile and Social Computing Lab, Fondazione Bruno Kessler. Trento, Italy.

\item[2019] \tab \enquote{Multiplex urban fingerprints for bicycle network planning} ANET-Talks, ANET Lab, Hungarian Academy of Science. Budapest, Hungary.
...
\begin{tablist}
\item[2019] \tab Natera Orozco, L. G., Battiston, F., Iñiguez González, G., and Szell, M. \enquote{Multiplex urban fingerprints for bicycle infrastructure planning} 2019 Cycling Research Board Meeting. Delft, Netherlands. October 31-1 November.
...
\item[2018] \tab Natera, L. Szell, M. \enquote{Characterizing cities from their multiplex infrastructure patterns} SICC Workshop ComplexCity@PoliTo. Turin, Italy.

\item[2013] \tab Natera, L. \enquote{Quiosco Libre, reading network in the public space} Future of Places. Stockholm, Sweden.
