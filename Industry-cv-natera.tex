...
\begin{list}{}{}
  ...
  \subitem{\textbf{Python devleoper} Implementation of GitHub template repository for cross projects reusability with CI/CD workflow for linting and testing. The template is currently in use across multiple projects.}
  \item{\textbf{Steel and aluminium decarbonization}}
  \subitem{\textbf{Python modeler.} Developed a python library for business data analysis to optimize investment decisions in order to reduce CO2 emissions.}
\end{list}
\vspace{0.25em}
