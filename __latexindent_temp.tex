...
\begin{list}{}{}
	\item[\textbf{Data Management}] \tab PostgreSQL, PostGIS, Data Analysis, Pattern \& Trend Identification, Data Visualization, Data wrangling with python (Pandas,) 
...
\begin{list}{}{}
  ...
  \subitem{\textbf{Project manager \& Data analyst.} Coordinate with the data science team the developing of a methodology to measure urban accessibility in 75 mexican cities using open data. The finds are currently being used to lobby local governments to improve the urban conditions.}
