...
\section*{Education}
\begin{tablist}
	\item[Ph.D. ] \tab Network Science, Central European University, Budapest, 2021 (expected) \\
...
\begin{tablist}
	...
	\item[\the\year] \tab Natera Orozco, L. G., Alessandretti, L., Szell, M., Battiston, F. \enquote{Multimodal transportation and mobility in urban networks} Target: \textit{Transport Review}
\end{tablist}
